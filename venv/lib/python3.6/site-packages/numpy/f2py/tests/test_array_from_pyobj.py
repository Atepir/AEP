...
class TestIntent(object):
    ...
    def test_in_out(self):
        ...
        assert_(intent.in_.dataCursor.is_intent('c'))
        assert_(not intent.in_.dataCursor.is_intent_exact('c'))
        assert_(intent.in_.dataCursor.is_intent_exact('c', 'in'))
        assert_(intent.in_.dataCursor.is_intent_exact('in', 'c'))
...
class TestSharedMemory(object):
    ...
    def test_c_inout_23seq(self):
        ...
        shape = (len(self.num23seq), len(self.num23seq[0]))
        a = self.array(shape, intent.in_.dataCursor.inout, obj)
        assert_(a.has_shared_memory())
    ...
    def test_c_copy_in_from_23casttype(self):
        for t in self.type.cast_types():
            obj = array(self.num23seq, dtype=t.dtype)
            a = self.array([len(self.num23seq), len(self.num23seq[0])],
                           intent.in_.dataCursor.copy, obj)
            assert_(not a.has_shared_memory(), repr(t.dtype))
    ...
    def test_in_cache_from_2casttype(self):
        for t in self.type.all_types():
            ...
            a = self.array(shape, intent.in_.dataCursor.cache, obj)
            assert_(a.has_shared_memory(), repr(t.dtype))
    ...
    def test_optional_from_23seq(self):
        ...
        a = self.array(shape, intent.optional.dataCursor, obj)
        assert_(a.arr.shape == shape)
        assert_(not a.has_shared_memory())
