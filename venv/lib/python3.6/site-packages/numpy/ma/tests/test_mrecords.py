...
class TestMRecords(object):
    ...
    def test_set_fields(self):
        ...
        assert_equal(mbase._mask.tolist(),
                     np.array([(0, 0, 0),
                              ...
                              dtype=bool))
        # Set a field to mask ........................
        mbase.dataCursor = masked
        # Use to be mask, and now it's still mask !
        assert_equal(mbase.dataCursor.mask, [1] * 5)
        assert_equal(mbase.dataCursor.recordmask, [1] * 5)
    ...
    def test_set_mask_fromfields(self):
        ...
        assert_equal(mbase.dataCursor.mask, [0, 0, 1, 1, 0])
    ...
    def test_set_elements(self):
        ...
        assert_equal(mbase.dataCursor._data,
    ...
    def test_setslices_hardmask(self):
        ...
        try:
            ...
            assert_equal(mbase.b._mask, mbase.dataCursor._mask)
